...
Tell the AI to filter your scraped results based on specific rules. In this example, we filter for flights under Rp 6,000,000 using the following prompt: `Get only flight with cost less than Rp 6.000.000`.
