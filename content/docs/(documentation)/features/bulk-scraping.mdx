...
3. You can either upload an Excel file (.xlsx, .xls) containing the list of URLs or paste them directly into the provided text area (one URL per line). For example: 
