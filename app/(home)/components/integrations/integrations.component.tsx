...
import {
  INTEGRATIONS_ITEMS,
  INTEGRATIONS_SECTION_CONFIG,
} from './integrations.constant'
      ...
      >
        <motion.div className="mb-10 md:mb-16" variants={itemVariants}>
          <p className="text-cyan-400 text-xl font-medium mb-4">
            {INTEGRATIONS_SECTION_CONFIG.heading}
          </p>
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6">
            {INTEGRATIONS_SECTION_CONFIG.description}
          </h2>
        </motion.div>
        <motion.div
          ...
          variants={containerVariants}
        >
          {INTEGRATIONS_ITEMS.map((feature) => {
            ...
            return (
              ...
              >
                <Link href={feature.link}>
                  <div
                    className="rounded-2xl p-6 flex flex-col items-start w-full h-auto min-h-[150px] bg-black text-left"
                  >
